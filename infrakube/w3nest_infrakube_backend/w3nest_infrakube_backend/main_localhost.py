...
from w3nest_infrakube_backend import __default__port__
from w3nest_infrakube_backend.app import start
from w3nest_infrakube_backend.environment import Configuration
...
def main() -> None:
    ...
    The serving port and w3nest's server port should be provided as command line arguments
